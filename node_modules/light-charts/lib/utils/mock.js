...
exports.getKLineMockData = exports.getBarMockData = void 0;
  ...
  return new Promise(function (resolved, rejected) {
    setTimeout(resolved, 500, new Array(pageSize).fill({}).map(function (item, index) {
      ...
      return {
        ...
        date: (0, _moment["default"])(endTime).subtract(pageSize - index - 1, 'days').format('MM-DD'),
...
exports.getKLineMockData = getKLineMockData;
function randn_bm() {
  var u = 0,
    v = 0;
...
var getBarMockData = function getBarMockData() {
  return new Promise(function (resolved, rejected) {
    setTimeout(resolved, 500, new Array(7).fill({}).map(function (item, index) {
      return {
        date: (0, _moment["default"])().subtract(7 - index - 1, 'days').format('MM-DD'),
        value: +('10' + Math.random().toString().slice(2, 3))
      };
    }));
  });
};
exports.getBarMockData = getBarMockData;